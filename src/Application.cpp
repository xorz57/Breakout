...
void Application::update([[maybe_unused]] float deltaTime) {
    if (!mGameOver) {
        if (mRegistry.view<Component::Brick>().empty()) {
            mGameOver = !mGameOver;
        }
    } else {
        mGameOver = !mGameOver;
...
void Application::renderWalls() {
    mRegistry.view<Component::Wall, Component::Transform>().each([this](entt::entity, const Component::Transform &transform) {
...
void Application::renderBricks() {
    mRegistry.view<Component::Brick, Component::Transform, Component::Sprite>().each([this](entt::entity, const Component::Transform &transform, const Component::Sprite &sprite) {
        SDL_Rect rect{static_cast<int>(transform.position.x), static_cast<int>(transform.position.y), static_cast<int>(transform.scale.x), static_cast<int>(transform.scale.y)};
...
void Application::renderBalls() {
    mRegistry.view<Component::Ball, Component::Transform>().each([this](entt::entity, const Component::Transform &transform) {
        SDL_Rect rect{static_cast<int>(transform.position.x), static_cast<int>(transform.position.y), static_cast<int>(transform.scale.x), static_cast<int>(transform.scale.y)};
...
void Application::renderPaddles() {
    mRegistry.view<Component::Paddle, Component::Transform>().each([this](entt::entity, const Component::Transform &transform) {
        SDL_Rect rect{static_cast<int>(transform.position.x), static_cast<int>(transform.position.y), static_cast<int>(transform.scale.x), static_cast<int>(transform.scale.y)};
        SDL_SetRenderDrawColor(mRenderer, 255, 255, 255, 255);
        SDL_RenderFillRect(mRenderer, &rect);
    });
...
void Application::respawnWalls() {
    mRegistry.view<Component::Wall>().each([this](entt::entity entity) {
        mRegistry.destroy(entity);
    });

    entt::entity entity1 = mRegistry.create();
    mRegistry.emplace<Component::Wall>(entity1);
    ...
    mRegistry.emplace<Component::Goal>(entity2);
    mRegistry.emplace<Component::Wall>(entity2);
    ...
    mRegistry.emplace<Component::Wall>(entity3);
    ...
    mRegistry.emplace<Component::Wall>(entity4);
...
void Application::respawnBricks() {
    ...
    mRegistry.view<Component::Brick>().each([this](entt::entity entity) {
        mRegistry.destroy(entity);
    });
    ...
    for (std::uint8_t row = 0; row < rows; ++row) {
        for (std::uint8_t col = 0; col < cols; ++col) {
            ...
            mRegistry.emplace<Component::Brick>(entity);
...
void Application::respawnBalls() {
    mRegistry.view<Component::Ball>().each([this](entt::entity entity) {
        mRegistry.destroy(entity);
    });

    entt::entity entity = mRegistry.create();
    mRegistry.emplace<Component::Ball>(entity);
...
void Application::respawnPaddles() {
    mRegistry.view<Component::Paddle>().each([this](entt::entity entity) {
        mRegistry.destroy(entity);
    });

    entt::entity entity = mRegistry.create();
    mRegistry.emplace<Component::Paddle>(entity);
...
void Application::updatePositions(float fixedDeltaTime) {
    mRegistry.view<Component::Ball, Component::Transform, Component::Movement>().each([&](entt::entity, Component::Transform &ballTransform, Component::Movement &ballMovement) {
    ...
    mRegistry.view<Component::Paddle, Component::Transform, Component::Movement>().each([&](entt::entity, Component::Transform &paddleTransform, Component::Movement &paddleMovement) {
        mRegistry.view<Component::Goal, Component::Transform>().each([&](entt::entity, const Component::Transform &goalTransform) {
...
void Application::checkCollisions() {
    mRegistry.view<Component::Ball, Component::Transform, Component::Movement>().each([&](entt::entity, const Component::Transform &ballTransform, Component::Movement &ballMovement) {
        mRegistry.view<Component::Goal, Component::Transform>().each([&](entt::entity, const Component::Transform &goalTransform) {
            if (checkAABBCollision(ballTransform, goalTransform) != CollisionLocation::None) {
                mGameOver = !mGameOver;
            }
        });

        mRegistry.view<Component::Wall, Component::Transform>().each([&](entt::entity, const Component::Transform &wallTransform) {
        ...
        mRegistry.view<Component::Brick, Component::Transform>().each([&](entt::entity entity, const Component::Transform &brickTransform) {
        ...
        mRegistry.view<Component::Paddle, Component::Transform>().each([&](entt::entity, const Component::Transform &paddleTransform) {
